...
enum PromptBuilder {
    ...
    static func roundDirective(_ round: Int) -> String {
        ...
        case 1:
            ...
            卡點 Quick Response Chips 由前端 UI 提供，quickOptions 給 []。\
            不要要求使用者先分類問題是工作／個人狀態／情緒問題。
            """
        case 2:
            return """
    ...
    - text：必填，繁體中文，依上面本輪指令。
    - quickOptions：0–5 個、每個 ≤8 字的快速回應選項；沒有就 []。
    ...
    static func summarySystem() -> String {
        ...
        規則：
        - 繁體中文約 100–150 字，優先保留真正影響這次卡關處理的資訊，不湊字數。
